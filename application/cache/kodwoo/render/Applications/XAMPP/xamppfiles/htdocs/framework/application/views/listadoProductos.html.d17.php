...
?>
				<tr>
					...
					<td><a class="" pid="<?php echo $this->scope["row"]['id'];?>" href="http://localhost/framework/index.php/Producto/frmModificarNombreProducto" ><?php echo utf8_decode((isset($this->scope["row"]['producto']) ? $this->scope["row"]['producto']:null));?></a></td>
